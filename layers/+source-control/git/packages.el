        ...
        (let ((mm-key dotspacemacs-major-mode-leader-key))
          (dolist (state '(normal motion))
            (evil-define-key state with-editor-mode-map
              (kbd (concat mm-key " " mm-key)) 'with-editor-finish
              (kbd (concat mm-key " a"))    'with-editor-cancel
              (kbd (concat mm-key " c"))    'with-editor-finish
              (kbd (concat mm-key " k"))    'with-editor-cancel)
            (evil-define-key state magit-log-select-mode-map
              (kbd (concat mm-key " " mm-key)) 'magit-log-select-pick
              (kbd (concat mm-key " a"))    'magit-log-select-quit
              (kbd (concat mm-key " c"))    'magit-log-select-pick
              (kbd (concat mm-key " k"))    'magit-log-select-quit))))
      ;; whitespace
